            ...
            if(res){
                ...
                _data.read('users',{accessToken : token},res=>{
                    if(res){
                        ...
                        if(userObject.liked){
                            userObject.liked.forEach(e=>{
                            _data.read('shops',{shopId : e},res=>{
                                var i = userObject.liked.indexOf(e);
                                delete res[0]._id;
                                delete res[0].users;
                                userObject.liked[i] = res[0];

                                // callback the user object
                                if(i == userObject.liked.length-1) callback(200,userObject);
